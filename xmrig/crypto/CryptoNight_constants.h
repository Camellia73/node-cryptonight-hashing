...
constexpr const size_t   CRYPTONIGHT_DARK_MEMORY  = 0.5 * 1024 * 1024;
constexpr const uint32_t CRYPTONIGHT_DARK_MASK    = 0x7FFF0;
constexpr const uint32_t CRYPTONIGHT_DARK_ITER    = 0x40000;
...
template<> inline constexpr size_t cn_select_memory<CRYPTONIGHT_DARK>()  { return CRYPTONIGHT_DARK_MEMORY; }
...
template<> inline constexpr uint32_t cn_select_mask<CRYPTONIGHT_DARK>()  { return CRYPTONIGHT_DARK_MASK; }
...
template<> inline constexpr uint32_t cn_select_iter<CRYPTONIGHT, VARIANT_XCN>()        { return CRYPTONIGHT_DARK_ITER; }
...
template<> inline constexpr uint32_t cn_select_iter<CRYPTONIGHT_DARK, VARIANT_0>()     { return CRYPTONIGHT_DARK_ITER; }
...
template<> inline constexpr Variant cn_base_variant<VARIANT_XCN>()   { return VARIANT_0; }
